...
{
    /** @return array{general: object|null, domains: Collection<int, object>, criteria: Collection<int, object>, submitted_self_assessments: int, total_domains: int, open_observations: int, noncompliant_descriptors: int, pending_review_descriptors: int, pending_evidence_descriptors: int, timeline: array<string, bool>} */

...
La aplicación contiene el dominio MySQL, autenticación, seguridad, administración versionada del instrumento MEC-SIM, creación/configuración de procesos, autoevaluación por dominio, gestión documental privada, revisión con subsanaciones y resultados ponderados con cierre formal. Las etapas 1 a 8 están implementadas y documentadas.
